...
class SSDConfig():
    def __init__(self):
        ...
        self.DECAY_LR_AT = [0.4,0.75] # fraction of total iteration where LR is decayed
        self.DECAY_FRAC = 0.5  # decay LR by this fraction of the current learning rate
        ...
        # -------------- --- --- --------
        self.VGG_BN_FLAG = True # whether vgg is used with or without batch norm.
        ...
        set_ratio = 2.
        self.FM_ASPECT_RATIO = [[set_ratio],
                                [set_ratio],
                                [set_ratio],
                                [set_ratio],
                                [set_ratio],
